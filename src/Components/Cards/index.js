...
function Cards() {
    ...
    const products = [
        { id: 0, nome: 'Pulseira Turmalina', descricao: `Pulseira ajustável com macramê, pedra natural turmalina rosa e pérola d'água com coração pintado à mão. Disponível também em outras pedras. A pintura pode ser na madrepérola ou na pérola d'água e o motivo coração ou estrela.`, valor: '150,00', foto: Imagem1 },
